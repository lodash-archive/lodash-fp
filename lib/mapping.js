module.exports = {
  ...
  'aryMethodMap': {
    1: (
      ...
      'round,template,trim,trimLeft,trimRight,words,zipObject').split(','),
    2: (
    ...
    3: (
      'assignWith,differenceBy,extendWith,intersectionBy,isEqualWith,isMatchWith,omitBy,' +
      'pickBy,pullAllBy,reduce,reduceRight,slice,transform,unionBy,xorBy,zipWith').split(','),
    4:
      ['fill', 'inRange']
  },
